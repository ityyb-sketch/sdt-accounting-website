  ...
  return (
    <div aria-hidden className="relative h-[420px] w-[420px]">
      ...
      <svg className="absolute inset-0 anim-orbit" viewBox="0 0 420 420">
        <g fill="none" stroke="#0D948840" strokeWidth="1">
      ...
      <div className="absolute left-6 top-10 anim-float-slower">
        <svg width="200" height="240" viewBox="0 0 200 240" className="drop-shadow-[0_18px_30px_rgba(40,80,160,0.18)]">
          <rect x="6" y="6" width="188" height="228" rx="14" fill="white" stroke="#CFE9E2" />
          <rect x="6" y="6" width="188" height="44" rx="14" fill="#E1F5EE" />
          <circle cx="26" cy="28" r="5" fill="#0D9488" />
          <rect x="40" y="23" width="80" height="10" rx="3" fill="#042F2AB3" />
          {[68, 92, 116, 140, 164, 188].map((y, i) => (
            <g key={y}>
              <rect x="22" y={y} width={90 - i * 6} height="8" rx="2" fill="#042F2A26" />
              <rect x="130" y={y} width={48} height="8" rx="2" fill="#0D948859" />
            </g>
          ))}
          {/* checkmark */}
          <path
      ...
      <div className="absolute right-2 top-32 anim-float">
        <svg width="220" height="200" viewBox="0 0 220 200" className="drop-shadow-[0_18px_30px_rgba(40,80,160,0.18)]">
          <rect x="6" y="6" width="208" height="188" rx="14" fill="white" stroke="#CFE9E2" />
          <rect x="22" y="22" width="80" height="8" rx="2" fill="#042F2A99" />
          <rect x="22" y="36" width="50" height="6" rx="2" fill="#042F2A40" />
          {/* baseline */}
          <line x1="22" y1="170" x2="200" y2="170" stroke="#CFE9E2" strokeWidth="1" />
          {/* bars */}
          {[
            { x: 30, h: 50, d: "0s" },
            { x: 60, h: 80, d: "0.15s" },
      ...
      <div className="absolute left-44 bottom-6 anim-float">
        <svg width="84" height="84" viewBox="0 0 84 84" className="drop-shadow-[0_10px_20px_rgba(40,80,160,0.25)]">
          <g className="anim-coin" style={{ transformBox: "fill-box", transformOrigin: "center" }}>
            <circle cx="42" cy="42" r="36" fill="#0D9488" />
