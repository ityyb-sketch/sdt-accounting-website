      ...
      <section className="container-page pb-8 md:pb-16">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {included.map((it, i) => (
            ...
            >
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-sky-soft text-[#0D9488] ring-1 ring-sky/20 transition-transform group-hover:scale-110">
                <it.icon size={18} />
              </span>
            ...
            {steps.map((s, i) => (
              ...
              >
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-sky-soft ring-1 ring-sky/30">
                  <span className="font-display text-lg font-bold text-[#0D9488]">{s.n}</span>
                </div>
