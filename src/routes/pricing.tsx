          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {oneTime.map((s, i) => (
              ...
              >
                ...
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-sky-soft text-[#3B5BFF] ring-1 ring-sky/20">
                  <s.icon size={22} />
                </div>
                <h3 className="mt-5 text-lg font-semibold text-navy">{s.title}</h3>
                <div className={`mt-2 font-display text-xl font-bold ${s.free ? "text-[#3B5BFF]" : "text-navy"}`}>{s.price}</div>
